/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7b5365c9728ad3dda15c067c0a07c475)
...
interface __BaseEnv_Env {
	...
	RUN_SESSION: DurableObjectNamespace<import("./src/server").RunSessionDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "RunSessionDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "FORGE_ENV" | "APP_URL" | "FORGE_CREDENTIAL_KEY" | "SOLARI_API_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
