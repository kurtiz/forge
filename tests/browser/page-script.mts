...
import { chooseRevealed, revealedElements } from '../../src/server/agent/operator'
import type { PageObservation } from '../../src/server/execution/types'
import {
  checkScript,
  clickScript,
  fillScript,
  ...
  selectScript,
  submitScript,
} from '../../src/server/execution/page-script'
